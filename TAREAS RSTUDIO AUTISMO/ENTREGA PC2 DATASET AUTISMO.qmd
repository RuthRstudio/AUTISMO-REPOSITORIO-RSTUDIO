...
El presente análisis tiene como propósito realizar una **exploración y visualización inicial del dataset sobre autismo**, con el fin de comprender su estructura, distribución de variables y posibles relaciones entre ellas. Este proceso forma parte del **Análisis Exploratorio de Datos (EDA, por sus siglas en inglés)**, una etapa fundamental en todo estudio estadístico o de aprendizaje automático, ya que permite identificar patrones, tendencias, inconsistencias y valores atípicos dentro del conjunto de datos.

El dataset utilizado contiene información relacionada con factores demográficos, clínicos y de comportamiento asociados al diagnóstico de autismo, incluyendo variables numéricas (como las puntuaciones de las preguntas del test y la edad) y categóricas (como género, etnicidad, país de residencia, entre otras).
